...
#---------------------------------1.实体类---------------------------------
-keep class com.glooory.huaban.entity.** { *; }
-keep class com.glooory.huaban.module.imagedetail.ImageDetailActivity {
    void startDownload();
    void cancelDownload();
}

-keep class com.glooory.huaban.module.main.MainActivity {
